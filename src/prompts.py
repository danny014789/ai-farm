...
|---------------|------------------------------------|--------------------------|
| water         | Activate water pump                | duration_sec (10-60)     |
...
## Action Constraints
- Water: duration_sec must be between 10 and 60. Minimum 60 minutes between waterings. Do NOT water if the water tank level is LOW — notify the human to refill instead.
